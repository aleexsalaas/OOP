...
<body>
            ...
            <?php if (!empty($infos)): ?>
                <?php foreach ($infos as $info): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($info['student_id']); ?></td>
                        <td><?php echo htmlspecialchars($info['subject_id']); ?></td>
                        <td><?php echo htmlspecialchars($info['enrollment_date']); ?></td>
                        <td class="action-btns">
                            <a href="editar.php?id=<?php echo $info['id']; ?>" class="action-btn edit-btn">Editar</a>
                            <a href="eliminar.php?id=<?php echo $info['id']; ?>" class="action-btn delete-btn">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
                    <td colspan="4" style="text-align: center;">No hay enrollments disponibles</td>
    ...
    <a href="#" class="btn">Agregar Enrollment</a>
</body>
</html>
