            ...
            <?php if (!empty($infos)): ?>
                <?php foreach ($infos as $info): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($info['user_id']); ?></td>
                        <td><?php echo htmlspecialchars($info['department_id']); ?></td>
                        <td class="action-btns">
                            <a href="editar_teacher.php?id=<?php echo $info['id']; ?>" class="action-btn edit-btn">Editar</a>
                            <a href="eliminar_teacher.php?id=<?php echo $info['id']; ?>" class="action-btn delete-btn">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
                    <td colspan="4" style="text-align: center;">No hay profesores disponibles</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>

    <a href="add-teachers" class="btn">Agregar Profesor</a>
</body>
</html>
