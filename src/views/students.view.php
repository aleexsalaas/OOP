...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php if (!empty($infos)): ?>
                <?php foreach ($infos as $info): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($info['dni']); ?></td>
                        <td><?php echo htmlspecialchars($info['enrollment_year']); ?></td>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" style="text-align: center;">No hay estudiantes disponibles</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>

    <a href="add-students" class="btn">Agregar Estudiante</a>
</body>
</html>
