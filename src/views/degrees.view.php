...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php if (!empty($infos)): ?>
                <?php foreach ($infos as $info): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($info['duration_years']); ?></td>
            ...
            <?php else: ?>
                <tr>
                    <td colspan="5" style="text-align: center;">No hay degrees disponibles</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>

    <a href="agregar_student.php" class="btn">Agregar Degrees</a>
</body>
</html>
