            ...
            <?php if (!empty($teachers)): ?>
                <?php foreach ($teachers as $teacher): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($teacher['subject_id']); ?></td>
                        <td><?php echo htmlspecialchars($teacher['exam_date']); ?></td>
                        <td><?php echo htmlspecialchars($teacher['description']); ?></td>
                        <td class="action-btns">
                            <a href="editar_teacher.php?id=<?php echo $teacher['id']; ?>" class="action-btn edit-btn">Editar</a>
                            <a href="eliminar_teacher.php?id=<?php echo $teacher['id']; ?>" class="action-btn delete-btn">Eliminar</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
                <tr>
                    <td colspan="4" style="text-align: center;">No hay examenes disponibles</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>

    <a href="agregar_teacher.php" class="btn">Agregar Examen</a>
</body>
</html>
